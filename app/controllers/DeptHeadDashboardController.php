...
class DeptHeadDashboardController extends BaseController {
	...
	*/
	...
	{
		$transactions = Application::where('department', '=', Auth::user()->department)
		...
		return View::make('depthead.dashboard', array('transactions' => $transactions));
	}
	...
	public function getTransactions($id)
	{
		...
		return View::make('depthead.transaction', array('id' => $oid, 'transaction' => $transaction, 'comments' => $comments, 'transactions' => array()));
	}
