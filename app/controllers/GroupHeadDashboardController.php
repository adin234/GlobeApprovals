...
class GroupHeadDashboardController extends BaseController {
	...
	*/
	...
	{
		$transactions = Application::where('group', '=', Auth::user()->group)
		...
		return View::make('grouphead.dashboard', array('transactions' => $transactions));
	}
	...
	public function getTransactions($id)
	{
		...
		return View::make('grouphead.transaction', array('id' => $oid, 'transaction' => $transaction, 'comments' => $comments, 'transactions' => array()));
	}
	...
	public function postTransactions($id)
	{
		...
		return Redirect::to('/grouphead/transactions/'.$id);
