...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li>
                    <i class="fa fa-dashboard"></i>  <a href="/grouphead/dashboard">Dashboard</a>
                </li>
                <li class="active">
    ...
    <div class="row">
        <form method="POST" class="clearfix col-lg-5" style="margin-top: 10px">
            ...
            @if ($transaction->numstatus == 3)
            <label for="approve" class=" pull-right" style="margin-right: 20px; margin-top: 10px;"><input type="checkbox" name="approved"/>Approve</label>
            @endif
        </form>
    </div>
@stop