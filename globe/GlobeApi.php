...
require_once(dirname(__FILE__).'/GlobeAuth.php');
require_once(dirname(__FILE__).'/Payment.php');

class GlobeApi {
    //THE BASE URL OF THE API
    const API_ENDPOINT = 'devapi.globelabs.com.ph';
    const GlobeAUTH_POINT = 'developer.globelabs.com.ph';
